...
proc cr_bd_design_1 { parentCell design_name } {
...
#  set design_name design_1
 ...
 ] [get_bd_intf_pins /axi_jtag_0/s_axi]
  ...
  # set DDR_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddrx_rtl DDR_0 ]
  # set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl FIXED_IO ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_jtag_0/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net debug_bridge_0_tap_tck [get_bd_ports tck] [get_bd_pins axi_jtag_0/TCK] [get_bd_pins ila_0/probe2]
  connect_bd_net -net debug_bridge_0_tap_tdi [get_bd_ports tdi] [get_bd_pins axi_jtag_0/TDI] [get_bd_pins ila_0/probe0]
  connect_bd_net -net debug_bridge_0_tap_tms [get_bd_ports tms] [get_bd_pins axi_jtag_0/TMS] [get_bd_pins ila_0/probe1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_jtag_0/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_200M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_200M_peripheral_aresetn [get_bd_pins axi_jtag_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_200M/peripheral_aresetn]
  connect_bd_net -net tap_tdo_0_1 [get_bd_ports tdo] [get_bd_pins axi_jtag_0/TDO] [get_bd_pins ila_0/probe3]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_jtag_0/s_axi/reg0] SEG_axi_jtag_0_reg0
